...
//                DataTable ds0 = new DataTable();
        ...
        private void feeFrequency()
        {
            ...
            mones[5] = "Half-Yearly";
 //           mones[6] = "Yearly";
            comboBox8.DataSource = mones;
            comboBox8.SelectedIndex = -1;

            comboBox10.DataSource = mones;
...
//                MessageBox.Show("retirement age is " + lRetAge );
                ...
                cquery += "wkd1,wkd2,wkd3,wkd4,wkd5,wkd6,wkd7,corp_Tax,cutype,biolink,retireage,guarPercent,prd_ID,chargeoffloor,annual_dues,feeFrequency,runFrequency)";
                cquery += " values " ;
                cquery += "(@lcompname,@laddr,@lcouid,@lcityid,@ltel,@lemail,@lclogo,@lcurrid,@llangid,@llcpin,@lsectype," ;
                cquery += "@llnwkd1,@llnwkd2,@llnwkd3,@llnwkd4,@llnwkd5,@llnwkd6,@llnwkd7,@llnCorpTax,@lcutype,@llnBioLink,@llnRetireAge,@lguarPercent,@lprd_id,@chargeoff,@tannual_dues,@tfeeFrequency,@trunFrequency)";
                ...
                comins.InsertCommand.Parameters.Add("@tfeeFrequency", SqlDbType.Int).Value = Convert.ToInt16(comboBox8.SelectedValue);
                comins.InsertCommand.Parameters.Add("@trunFrequency", SqlDbType.Int).Value = Convert.ToInt16(comboBox10.SelectedValue);
        ...
        private void updatecompany()
        {
            using (SqlConnection ndConnHandle = new SqlConnection(cs))
            {
                ...
                cquery1 += "sharectrl_stf =@lsharectrl_stf,guarPercent=@lguarPercent,prd_id=@lprd_id,chargeoffloor = @chargeoff, writeoffloor=@writeoffloor,annual_dues=@tannual_dues,feeFrequency=@tfeeFrequency,runFrequency=@trunFrequency where compid =@lgnCompanyCode";
                ...
                comupd.UpdateCommand.Parameters.Add("@chargeoff", SqlDbType.Int).Value = Convert.ToInt16(textBox7.Text);
                comupd.UpdateCommand.Parameters.Add("@writeoffloor", SqlDbType.Int).Value = Convert.ToInt16(textBox13.Text);
                comupd.UpdateCommand.Parameters.Add("@tannual_dues", SqlDbType.Decimal).Value = Convert.ToDecimal(textBox14.Text);
                comupd.UpdateCommand.Parameters.Add("@tfeeFrequency", SqlDbType.Int).Value = Convert.ToInt16(comboBox8.SelectedValue);
                comupd.UpdateCommand.Parameters.Add("@trunFrequency", SqlDbType.Int).Value = Convert.ToInt16(comboBox10.SelectedValue);
