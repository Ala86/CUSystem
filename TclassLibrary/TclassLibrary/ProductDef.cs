...

    {
        ...
        private void insertproduct()
        {
          ...
          //  string lprodAcc = Convert.ToString(comboBox9.SelectedValue);
           ...
           // string prodcontrol = comboBox1.SelectedValue = 130 ? lprodAcc : sproAcc;
            //  MessageBox.Show("inside product step 4");



            //            string ltranCode = Convert.ToString(comboBox12.SelectedValue);
            bool lprodMan = (radioButton18.Checked ? true : false);
            ...
            using (SqlConnection ndConnHandle1 = new SqlConnection(cs))
            {
                ...
                cquery += "deduct,destype,souproduct,desacct,freq,dedtype,dedamt,fromdate,todate,profreq,prod_type)";
                ...
                cquery += "@lDeduct,@lDestype,@nsouProd,@cdesAcct,@nFreq,@ldedType,@ndedAmt,@dfromdate,@dtodate,@tnProFreq,@prodtype)";
                ...
                myCommand.InsertCommand.Parameters.Add("@lprod_control", SqlDbType.Char).Value = Convert.ToString(comboBox1.SelectedValue) != "130" ? sproAcc : lprodAcc;//lprodAcc;
                ...
                myCommand.InsertCommand.Parameters.Add("@lsprod_control", SqlDbType.Char).Value = Convert.ToString(comboBox1.SelectedValue) != "130" ? sproAcc : "";
                ...
                myCommand.InsertCommand.Parameters.Add("@prodtype", SqlDbType.Int).Value = Convert.ToInt32(comboBox1.SelectedValue);
        ...
        private void getDestAccounts(string tcacctype)
        {
            using (SqlConnection ndConnHandle1 = new SqlConnection(cs))
            {
                ...
                string dsql1a = "select prod_control,prd_name from prodtype";
                SqlDataAdapter da1a = new SqlDataAdapter(dsql1a, ndConnHandle1);
                DataTable ds1a = new DataTable();
                da1a.Fill(ds1a);
                if (ds1a != null && ds1a.Rows.Count > 0)
                {
                    comboBox30.DataSource = ds1a.DefaultView;
                    comboBox30.DisplayMember = "prd_name";
                    comboBox30.ValueMember = "prod_control";
                    comboBox30.SelectedIndex = -1;
                }
