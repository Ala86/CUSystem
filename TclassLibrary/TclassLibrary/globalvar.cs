...
namespace TclassLibrary
{
    public static class globalvar
    {
        ...
        public static string gcsusername = "";
         ...
         //    public static string cos = "Server=.;Database =NA_SOF001;User ID = sa;Password=Whatever4999!; connection Timeout = 3000000";  //connection to local database
        ...
        //  public const string cos = "Server=.;Database=NA_SOF001;User ID = sa; Password=Whatever4999!; connection Timeout = 3000000";  
        //public const string cos = "Server =212.60.68.150,1433; Database = NA_NEM001;Integrated Security=True"; //connection to local tcaretemplate
        // public const string cos = "Server=.;Database=NA_BRE001;User ID = sa;Password=Whatever4999!; connection Timeout = 3000000";  //connection to local database
        public const string gcCopyRight = "Copyright Naccug Systems. All Rights Reserved.";
