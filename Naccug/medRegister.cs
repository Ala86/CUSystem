...
namespace WinTcare
{
    public partial class medRegister : Form
    {
        public medRegister()
        {
            InitializeComponent();
        ...
        private void medRegister_Load(object sender, EventArgs e)
        {
            this.Text = globalvar.cLocalCaption + "<< Medical Scheme Registration >>";
