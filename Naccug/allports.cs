...
public class Win32DeviceMgmt
{
    ...
    public static string Listit();
    public static string device
    {
      set Guid guidComPorts = new Guid(GUID_DEVINTERFACE_COMPORT);

        set IntPtr hDeviceInfoSet = SetupDiGetClassDevs(ref guidComPorts, 0, IntPtr.Zero, DIGCF_PRESENT | DIGCF_DEVICEINTERFACE);
