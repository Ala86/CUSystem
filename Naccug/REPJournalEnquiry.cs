...
namespace WinTcare
{
    public partial class REPJournalEnquiry : Form
    {
        string cs = globalvar.cos;

        ReportDocument rprt = new ReportDocument();
        public REPJournalEnquiry()
        {
            InitializeComponent();
        }
        void BranchCombo()
        ...
        public void GETDATA()
        {
            ...
            SqlConnection ndConnHandle1 = new SqlConnection(cs);
            rprt.Load(System.Windows.Forms.Application.StartupPath + "\\Reports\\CRYJournalEnquiry.rpt");
            SqlCommand cmd = new SqlCommand("tsp_JournalEnquiry", ndConnHandle1);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            sda.Fill(ds, "tsp_JournalEnquiry");
            rprt.SetDataSource(ds);
            crystalReportViewer1.ReportSource = rprt;
        }

        private void REPJournalEnquiry_Load(object sender, EventArgs e)
        {
            BranchCombo();
            companyCombo();
        }
