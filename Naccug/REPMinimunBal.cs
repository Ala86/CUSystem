...
namespace WinTcare
{
    public partial class REPMinimunBal : Form
    {
        ReportDocument rprt = new ReportDocument();
        string cs = globalvar.cos;
        public REPMinimunBal()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            rprt.Load(System.Windows.Forms.Application.StartupPath + "\\Reports\\CRPMinimumBal.rpt");
        ...
        private void REPMinimunBal_Load(object sender, EventArgs e)
        {
            ProductCombo();
        }
        void ProductCombo()
